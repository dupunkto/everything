<?php
  // Drag-to-create target for the week view: drops a bare "New event" on the
  // default calendar spanning the dragged range, then hands back its id so the
  // client can pop the editor open on it. Everything else is filled in there.
